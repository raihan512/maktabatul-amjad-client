        ...
        <section className='my-12'>
                                ...
                                <div className=''>
                                    <div className='flex items-center justify-center'>
                                        <div className='w-8/12'>
                                            <h3 className='hero-title text-lg md:text-xl lg:text-2xl xl:text-4xl font-bold line-clamp-2'>Interpretation Of The Great Qur'an Tafsir Ibn Kathir I Ibn Hazm </h3>
                                            ...
                                            <Link className='text-primary text-base lg:text-lg hover:underline' to=''>View more</Link>
                                        </div>
                                        <div className='w-4/12'>
                                            <div>
                                            <img src='https://www.noor-book.com/publice/covers_cache_webp/1/d/d/5/02f62b4165dd537df60326da06d3724d.jpg.webp' className='w-full lg:w-9/12 xl:w-7/12 ml-auto' alt=''/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div className='absolute top-3/5 left-0 w-full px-1 lg:px-2 flex justify-between'>
                ...
                <button onClick={() => sliderBtns.current.slickNext()} className='py-4 px-1 bg-gray'><IoIosArrowForward className='text-white text-lg md:text-xl'/></button>
                    ...
                    <div className='md:col-span-4 lg:col-span-2 xl:col-span-1 p-5 bg-black'>
                            <div className='bg-olive py-2 px-4 md:-ml-10 md:mr-8 text-center mb-5'>
                                <p className='text-sm md:text-base lg:text-lg text-white'>TODAY HIGHLIGHT</p>
                            </div>
                        <div className='flex justify-between items-center pb-2 border-b border-dashed border-gray'>
                            ...
                            <div className='w-7/12'>
                                <p className='text-white text-base line-clamp-2'>Interpretation of the Great Qur'an Interpretation of Ibn Katheer </p>
                                <Link to='' className='text-gray text-sm hover:text-primary hover:underline truncate'>Ibn Kathir</Link>
                                <div className='flex'>
                                ...
                                <div className='flex mt-2'>
                                    <del className='text-red'><p className='mr-2'>$<span>25.00</span></p></del>
                                    <p className='text-primary'>$<span>25.00</span></p>
                                </div>
                            </div>
                        </div>
